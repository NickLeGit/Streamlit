...
st.title('French national assembly visualisation tool')
st.markdown("""
...
nb_mbrs = st.sidebar.slider("Number of members", int(nb_deputies.min()), int(nb_deputies.max()),
                            (int(nb_deputies.min()), int(nb_deputies.max())), 1)
...
# color associated with each party
